...
| 8 | [Отток клиентов](https://github.com/kirill-pribludenko/projects/blob/main/8/project_06.ipynb)   	| Банк | Классификация  |`RandForest` `SVC` `Catboost` `Mathplotlib`  | Kaggle, несбалансированный датасет    	|
