...
| №   | Название  |Сфера  | Тип  | Задача  | Инструменты и Методы  | Ключевые слова | Комментарии  |
|:---:|:---:      |:---:  |:---: |:---:    |---                    |---	            |---           |
| 1   | [For_Junior_ML_Contest](1/For_Junior_ML_Contest.ipynb) | Промышленность | Регрессия  | Опис.задачи | `LinReg`, `RandForest`, `Catboost`, `optuna` | Предобработка, бустинг, подбор параметров| Особенности - EDA, нужно было выделить признаки из разных таблиц по определенному интервалу времени |
| 2   |   	      |   	  |   	 |         |                       |                |              |
|     | продолжение следует |
