...
| 3   | [Классификация текста](https://github.com/kirill-pribludenko/projects/blob/main/3/project_12.ipynb)   	| Ритейл         | NLP, Классификация  |`Logistic Regression` `Catboost` `TF-IDF` `BERT`   | Рассмотрены два варианта решения    	|
