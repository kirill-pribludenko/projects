...
| 10 | [ODS-alice](Competitions/ods-alice/my_alice_v2.ipynb)   	| Classification  | `LogisticRegression` `RandForest` `SVC` `GaussianNB` `Mathplotlib`  | One of the first ML notebooks |
|   	| will be soon  	|   	|   	|
